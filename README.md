...
CDN builds for aframe-extras/v4.0.1:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v4.0.1/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v4.0.1/dist/aframe-extras.min.js) *(production)*
