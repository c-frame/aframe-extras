...
```html
<script src="//cdn.rawgit.com/donmccurdy/aframe-extras/v3.12.2/dist/aframe-extras.min.js"></script>
```

CDN builds for aframe-extras/v3.12.2:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.12.2/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.12.2/dist/aframe-extras.min.js) *(production)*
