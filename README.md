...
CDN builds for aframe-extras/v2.5.2:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v2.5.2/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v2.5.2/dist/aframe-extras.min.js) *(production)*
