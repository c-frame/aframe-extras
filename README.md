...
CDN builds for aframe-extras/v3.8.5:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.8.5/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.8.5/dist/aframe-extras.min.js) *(production)*
