...
CDN builds for aframe-extras/v3.11.4:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.11.4/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.11.4/dist/aframe-extras.min.js) *(production)*
