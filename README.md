...
```html
<script src="//cdn.rawgit.com/donmccurdy/aframe-extras/v2.7.4/dist/aframe-extras.min.js"></script>
```

CDN builds for aframe-extras/v2.7.4:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v2.7.4/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v2.7.4/dist/aframe-extras.min.js) *(production)*
