...
```html
<script src="//cdn.rawgit.com/donmccurdy/aframe-extras/v1.15.0/dist/aframe-extras.min.js"></script>
```

CDN builds for aframe-extras/v1.15.0:

- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v1.15.0/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v1.15.0/dist/aframe-extras.min.js) *(production)*
