...
- [aframe-extras.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.3.0/dist/aframe-extras.js) *(development)*
- [aframe-extras.min.js](https://cdn.rawgit.com/donmccurdy/aframe-extras/v3.3.0/dist/aframe-extras.min.js) *(production)*
